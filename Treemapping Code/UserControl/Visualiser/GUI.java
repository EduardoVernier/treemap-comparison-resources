...
public final class GUI extends javax.swing.JFrame {
    ...
    public GUI(Visualiser visualiser) {
        ...
        String[] facilitators = new String[]{"m-coffee", "m-names", "Random", "SeqRandom", "RandomLogNormal", "SeqRandomLogNormal", "Poisson", "spacemacs", "fsharp", "hiv", "standard", "hystrix", "gen1", "PopularNames", "PopularNames2", "KijkCijfers10"};
        ...
        String[] generators = new String[]{"SliceAndDice", "PivotByMiddle", "PivotBySize", "PivotBySplitSize", "Strip", "StripLookAhead", "Split", "Squarified", "SquarifiedLookAhead", "Spiral", "SpiralLookAhead", "Moore", "Hilbert", "Approximation", "Incremental", "NoMovesIncremental"};
    ...
    public void setDataFacilitator(String identifier) {
        ...
        switch (identifier) {
            ...
            case "SeqRandomLogNormal":
                ...
                break;
            case "spacemacs":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + "\\dataSetsCorrected\\spacemacs.data");
                break;
            case "fsharp":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + "\\dataSetsCorrected\\fsharp.data");
                break;
            case "hiv":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + "\\dataSetsCorrected\\hiv.data");
                break;
            case "standard":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + "\\dataSetsCorrected\\standard.data");
                break;
            case "hystrix":
                df = new DataFileManagerFast(new File("").getAbsolutePath() + "\\dataSetsCorrected\\hystrix.data");
                break;
            case "m-names":
                df = new DataFileManager(new File("").getAbsolutePath() + "\\dataSetsCorrected\\m-names.data");
                break;
            case "m-coffee":
                df = new DataFileManager(new File("").getAbsolutePath() + "\\dataSetsCorrected\\coffee.csv");
                break;
        }

    ...
    private void runExperiments() {
        ...
        for (TreeMapGenerator generator : generators) {
            ...
            for (DataFacilitator facilitator : facilitators) {
                System.out.println("facilitator = " + facilitator.getData(3).getHeight());
...
//                modelController.newStatisticsFile(new File("experiment/" + generator.getClass().getName() + ";" + generator.getParamaterDescription()));
                ...
                String faceOutputString = "" + outputFolder.getAbsoluteFile() + "\\NoMoves" + generator.getClass().getSimpleName() + "\\" + name;
                ...
                try {
                    ...
                    if (generateBaseLines) {
                        File baseLineOutputFolder = new File("" + outputFolder.getAbsoluteFile() + "\\NoMoves" + generator.getClass().getSimpleName() + "\\baseLine" + name);
